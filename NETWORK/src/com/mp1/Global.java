...
public class Global {
	public static int nChunksBeforeBuffer=1;package com.mp1;
...
public class Global {
	...
	public static final int SERVER_LOSS_PROBABILITY = 60;
	public static final int CLIENT_LOSS_PROBABILITY = 60;
